...
public class JourneyDtails extends JFrame{  //Forth
	...
	String[] items1 =  {"Islamabad", "Karachi", "Lahore", "Peshawar","Kashmir","Multan"};
	JComboBox comboBox = new JComboBox(items1);
	comboBox.setBounds(150, 100, 150, 27);
	add(comboBox);
		
		
	String[] items2 =  {"Islamabad", "Karachi", "Lahore", "Peshawar","Kashmi","Multan"};
